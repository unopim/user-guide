...
Sekcja **Usage History** pozwala przeglądać przeszłą aktywność w konfigurowalnych zakresach dat. Zapewnia:
...
Dashboard analytics to warstwa obserwowalności znajdująca się na szczycie kontroli skonfigurowanych w **Magic AI → Settings → Agentic PIM**. Razem tworzą pętlę zwrotną:
