...
Aby uzyskać dostęp do powiadomień, kliknij **ikonę dzwonka** w górnym pasku nawigacyjnym panelu administracyjnego. Otwiera to panel powiadomień, w którym możesz wyświetlić wszystkie ostatnie alerty.
 ...
 <ImagePopup src="/assets/2.0/images/notifications/notification-panel.png" alt="Panel powiadomień" />
...
Powiadomienia mogą Cię alertować, gdy występują znaczące modyfikacje danych produktów, takie jak masowe aktualizacje lub zmiany dokonywane przez API. Jest to przydatne, gdy wielu członków zespołu pracuje jednocześnie nad katalogiem produktów.
