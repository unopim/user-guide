...
Het bevat vier onafhankelijke secties, één per capability:
...
<ImagePopup src="/assets/2.0/images/magic-ai/magic-ai-settings.png" alt="Magic AI-instellingen" />

## 1. Agentic PIM

Regelt de conversationele AI Agent en de achtergrondworkflows die het aandrijft (auto-enrichment bij productaanmaak, Catalog Quality Monitor, goedkeuringswachtrij).
...
| **Default Platform** | Welk Platform tekstverzoeken bedient. Kies **`-- Use Default Platform --`** om het ster-default te volgen, of overschrijf met een specifiek platform. Platforms gemarkeerd met `*` in de dropdown zijn de huidige standaard. |
...
| **Default Platform** | Een image-capable Platform. Kies **`-- Use Default Platform --`** om het ster-default te volgen; `*` in de dropdown markeert de huidige standaard. |
...
| **Default Platform** | Het Platform dat wordt gebruikt voor vertaalverzoeken. Kies **`-- Use Default Platform --`** om het ster-default te volgen; `*` in de dropdown markeert de huidige standaard. |
