...
<ImagePopup src="/assets/2.0/images/attributes/general.png" alt="Algemene sectie" />
...
<ImagePopup src="/assets/2.0/images/attributes/label.png" alt="Label-sectie" />

**Stap 4** — Selecteer **Validation** als u wilt dat het Attribute verplicht of uniek is.

**Opmerking** — De **Is Unique**-validatie is alleen beschikbaar voor typen **Text, Datetime & Date**.

<ImagePopup src="/assets/2.0/images/attributes/validation.png" alt="Validatie-sectie" />
...
<ImagePopup src="/assets/2.0/images/attributes/configuration.png" alt="Configuratiesectie" />
...
Klik op **Save Attribute**. Het nieuwe attribuut verschijnt in de Datagrid.
...
<ImagePopup src="/assets/2.0/images/attributes/family.png" alt="Attribuutset-toewijzing" />
...
<ImagePopup src="/assets/2.0/images/attributes/product.png" alt="Attribuut weergegeven op productbewerk-pagina" />
...
<ImagePopup src="/assets/2.0/images/attributes/text.png" alt="Text-attribuut" />
...
<ImagePopup src="/assets/2.0/images/attributes/textarea.png" alt="Textarea-attribuut" />

**3) Boolean** — Waar / onwaar-schakelaar. Gebruikt voor ja/nee- of aan/uit-selecties.

<ImagePopup src="/assets/2.0/images/attributes/boolean.png" alt="Boolean-attribuut" />

**4) Select** — Een dropdown waarmee u één keuze uit een vooraf gedefinieerde lijst kunt maken.

<ImagePopup src="/assets/2.0/images/attributes/select.png" alt="Select-attribuut" />

**5) Multiselect** — Net als Select, maar staat meerdere keuzes uit de lijst toe.

<ImagePopup src="/assets/2.0/images/attributes/multiselect.png" alt="Multiselect-attribuut" />

**6) Datetime** — Kies een specifieke datum en tijd. Gebruikt voor planning en tijdstempels.

<ImagePopup src="/assets/2.0/images/attributes/datetime.png" alt="Datetime-attribuut" />

**7) Date** — Kies alleen een datum (geen tijdcomponent).

<ImagePopup src="/assets/2.0/images/attributes/date.png" alt="Date-attribuut" />
...
<ImagePopup src="/assets/2.0/images/attributes/gallery.png" alt="Gallery-attribuut met video" />
...
<ImagePopup src="/assets/2.0/images/attributes/image.png" alt="Image-attribuut" />

**10) File** — Upload willekeurige bestanden (documenten, afbeeldingen, enz.).

<ImagePopup src="/assets/2.0/images/attributes/file.png" alt="File-attribuut" />

**11) Checkbox** — Een aan/uit-schakelbaar selectievakje voor binaire selecties (overeenkomsten, voorkeuren).

<ImagePopup src="/assets/2.0/images/attributes/checkbox.png" alt="Checkbox-attribuut" />

**12) Price** — Een prijsveld naast het vooraf gedefinieerde **Prices**-attribuut.

<ImagePopup src="/assets/2.0/images/attributes/price.png" alt="Price-attribuut" />
