...
<ImagePopup src="/assets/2.1/images/simple-product/product-edit-locale.png" alt="Product Edit met Locale Switcher" />
...
Klik op **Filter** boven het datagrid om de drawer **Apply Filters** vanuit de rechterkant van het scherm open te schuiven. De drawer draagt een vaste set ingebouwde filtervelden plus een knop **Add Filter** voor aangepaste attributen.
