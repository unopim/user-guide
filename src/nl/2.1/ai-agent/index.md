...
Elk chatbericht stroomt door de **Agentic PIM Pipeline**, een lus van 5 stappen die zorgt voor veiligheid, precisie en transparantie:
...
### Associatiebeheer *(Nieuw in v2.1.0)*
Voeg gerelateerde producten, up-sells en cross-sells toe, verwijder, toon of spiegel ze via conversatie — geen noodzaak om elke productbewerk-pagina te openen. Productzoekresultaten in de chat worden nu weergegeven als **klikbare links** zodat u direct naar de productbewerk-pagina kunt springen.
