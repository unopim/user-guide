...
const features = [
  // v2.1.0
  { title: 'Manage Associations Tool', desc: 'Nieuwe AI Agent-tool die gerelateerde/up-sell/cross-sell-producten toevoegt, verwijdert of toont via natuurlijke taal — niet langer nodig om elk product handmatig te openen. Productzoekresultaten tonen nu klikbare links voor gestroomlijnde navigatie.', version: 'v2.1.0', domains: ['ai', 'productivity'] },
  { title: 'Demo Data Seeding', desc: 'Snelle onboarding met voorbeeldproducten, categorieën en attributen — beschikbaar via de installer-wizard-toggle, de CLI-vlag `php artisan unopim:install --with-demo-data`, de Docker-setup-optie of het standalone-commando `php artisan unopim:install:demo-data`.', version: 'v2.1.0', domains: ['productivity', 'governance'] },
  { title: 'Productieklare Docker-setup', desc: 'Multi-container-stack (Nginx + PHP-FPM standaard, Apache fallback) verzonden via Docker Hub-images, met healthchecks, Redis-, Elasticsearch-, Mailpit-services, OPcache-getunede php.ini en auto-publish-workflow.', version: 'v2.1.0', domains: ['connectivity', 'scalability'] },
  { title: 'MagicAI Custom Provider', desc: 'Verbind elke OpenAI-compatibele service (zelf-gehoste gateways, proxies, aangepaste endpoints) door een aangepaste base URL te configureren op de pagina Magic AI Platforms — buiten de officiële OpenAI/Anthropic/Gemini/Ollama/Groq-presets.', version: 'v2.1.0', domains: ['ai', 'connectivity'] },
  { title: 'MagicAI Test Connection (ModelRecommender)', desc: 'Test Connection op een Platform gebruikt nu een speciale aanbeveler die image-only modellen overslaat, ter voorkoming van false negatives tijdens credential-validatie.', version: 'v2.1.0', domains: ['ai', 'governance'] },
  { title: 'PrismErrorResolver', desc: 'AI Agent Chat vertaalt provider- en Prism-fouten naar gebruikersvriendelijke berichten, zodat admins direct begrijpen wat er misging (rate limit, ongeldige sleutel, model niet beschikbaar, enz.).', version: 'v2.1.0', domains: ['ai', 'productivity'] },
  { title: 'Klikbare Dashboard productstatistieken', desc: 'Productstatistiek-kaarten op het Dashboard (Active, Inactive, Enriched, With Variants, …) fungeren nu als filterchips — klikken op één linkt diep naar de productgrid vooraf gefilterd op die set.', version: 'v2.1.0', domains: ['productivity', 'reporting'] },
  { title: 'Asynchrone Product-Webhook-dispatch', desc: 'Productaanmaak-/-update-webhookleveringen draaien nu als een wachtrij-SendProductWebhook-job, zodat admin-acties onmiddellijk terugkeren en externe endpoint-latentie de admin-UI niet langer blokkeert.', version: 'v2.1.0', domains: ['connectivity', 'automation', 'scalability'] },
  { title: 'Admin Login Rate Limiting', desc: 'Genaamde rate limiters met per-e-mail + per-IP-segmentatie (5 pogingen/minuut) beschermen de admin-login en forgot-password-endpoints tegen brute-force-aanvallen.', version: 'v2.1.0', domains: ['governance', 'scalability'] },
  { title: 'Server-Side Wachtwoordvalidatie', desc: 'Minimum 6-tekens wachtwoordlengte server-side afgedwongen in UserForm, sluit een gat waar clients wachtwoordregels konden omzeilen.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'User-Enumeration Hardening', desc: 'Forgot-password-endpoint retourneert nu een generiek bericht ongeacht of de e-mail bestaat, ter voorkoming van account-enumeratie via responsverschillen.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Open-Redirect-bescherming', desc: 'Referer-gebaseerde redirects op login en forgot-password valideren nu de host via parse_url(), zodat vervalste Referer-headers gebruikers niet langer naar externe phishingsites kunnen pushen.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'User-Edit Privilege Escalation Fix', desc: 'Ontbrekende ACL-entries en controller-niveau-guards toegevoegd op de user update- en destroy-endpoints; niet-superadmins kunnen geen permission_type: all-rollen meer toewijzen. Verhelpt de High-severity audit-bevinding.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'No-Cache Middleware voor Admin-pagina\'s', desc: 'Admin-responsen bevatten Cache-Control: no-store en Pragma: no-cache-headers die voorkomen dat browsers en proxies gevoelige pagina\'s cachen na uitloggen.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Verbeterde Secure Headers', desc: 'Permissions-Policy- en X-Permitted-Cross-Domain-Policies-headers worden nu op alle admin-responsen verzonden voor sterkere bescherming op browserniveau.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'XSS-saneringshelper', desc: 'clean_content()-helper, ondersteund door HTMLPurifier, strips Blade-directieven, PHP-tags en gevaarlijke HTML uit door gebruikers gegenereerde content vóór opslag.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'IP-gebaseerde Debug-filtering', desc: 'APP_DEBUG_ALLOWED_IPS env-variabele beperkt debugbar-toegang tot specifieke IPs, zodat productie-debugging veiliger is.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Verbeterde Nederlandse (nl_NL) vertalingen', desc: 'Kwaliteitsronde over negen pakketten (Admin, AiAgent, Completeness, Core, DataTransfer, Installer, Product, Webhook) — informele toon, verwijdering van overgebleven prefixen, opschoning van zero-width-spaces. Community-bijdrage.', version: 'v2.1.0', domains: ['productivity'] },
  { title: 'Database Index Performance-ronde', desc: 'Nieuwe indexen op channels.code, locales.status, currencies.status en een samengestelde index op core_config(code, channel_code, locale_code) voor snellere config-lookups en admin-pagina-laadtijden.', version: 'v2.1.0', domains: ['scalability'] },
  { title: 'PostgreSQL-compatibiliteitsronde', desc: 'JSON-zoekondersteuning, jsonContains()-grammar, driver-afhankelijke MySQL bulk-mode-sessievars en DataGrid-filterfixes over AiAgent-tools, Channel- en AttributeOption-grids.', version: 'v2.1.0', domains: ['connectivity', 'scalability'] },
  { title: 'Dark-Mode-polijst in Taakvolger', desc: 'Voortgangsbalken en configuratieknoppen renderen nu correct in dark mode in de import-/exportjob-tracker.', version: 'v2.1.0', domains: ['productivity'] },
  { title: 'PostgreSQL CI-workflow', desc: 'Dedicated Pest-testrun tegen PostgreSQL 16 (met en zonder Elasticsearch) bij elke wijziging houdt cross-database-compatibiliteit stabiel.', version: 'v2.1.0', domains: ['scalability', 'governance'] },
