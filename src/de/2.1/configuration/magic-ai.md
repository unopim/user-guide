...
<ImagePopup src="/assets/2.1/images/configuration/AiConfiguration.png" alt="Magic AI-Konfigurationsübersicht" />
...
Die Pipeline ist für jede KI-Funktion dieselbe — von der Feldgenerierung bis zum AI Agent:
...
<ImagePopup src="/assets/2.1/images/magic-ai/magic-ai-config-flow.png" alt="Magic AI-Konfigurationshierarchie" />
...
<ImagePopup src="/assets/2.1/images/magic-ai/add-platform.png" alt="KI-Plattform hinzufügen — Schritt 1" />
...
- Ein **Prompt** sagt, *was* für ein bestimmtes Feld geschrieben werden soll („Schreibe eine Produktbeschreibung …").
