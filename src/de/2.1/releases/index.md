...
const features = [
  // v2.1.0
  { title: 'Manage Associations Tool', desc: 'Neues AI-Agent-Tool, das verwandte/Up-Sell-/Cross-Sell-Produkte über natürliche Sprache hinzufügt, entfernt oder auflistet — kein manuelles Öffnen jedes Produkts mehr erforderlich. Produkt-Suchergebnisse zeigen jetzt anklickbare Links für eine optimierte Navigation an.', version: 'v2.1.0', domains: ['ai', 'productivity'] },
  { title: 'Demodaten-Seeding', desc: 'Schnelles Onboarding mit Beispielprodukten, -kategorien und -attributen — verfügbar über den Installer-Assistenten-Schalter, das CLI-Flag `php artisan unopim:install --with-demo-data`, die Docker-Setup-Option oder den eigenständigen Befehl `php artisan unopim:install:demo-data`.', version: 'v2.1.0', domains: ['productivity', 'governance'] },
  { title: 'Produktionsreifes Docker-Setup', desc: 'Multi-Container-Stack (standardmäßig Nginx + PHP-FPM, Apache-Fallback), ausgeliefert über Docker-Hub-Images, mit Healthchecks, Redis, Elasticsearch, Mailpit-Diensten, OPcache-optimierter php.ini und Auto-Publish-Workflow.', version: 'v2.1.0', domains: ['connectivity', 'scalability'] },
  { title: 'MagicAI Custom Provider', desc: 'Verbinden Sie jeden OpenAI-kompatiblen Dienst (selbstgehostete Gateways, Proxys, benutzerdefinierte Endpunkte), indem Sie auf der Magic-AI-Plattformen-Seite eine benutzerdefinierte Basis-URL konfigurieren — über die offiziellen OpenAI/Anthropic/Gemini/Ollama/Groq-Voreinstellungen hinaus.', version: 'v2.1.0', domains: ['ai', 'connectivity'] },
  { title: 'MagicAI Test Connection (ModelRecommender)', desc: 'Test Connection auf einer Plattform verwendet nun einen dedizierten Recommender, der bildbasierte Modelle überspringt und so falsche Negative bei der Validierung von Anmeldedaten verhindert.', version: 'v2.1.0', domains: ['ai', 'governance'] },
  { title: 'PrismErrorResolver', desc: 'Der AI Agent Chat übersetzt Provider- und Prism-Fehler in benutzerfreundliche Nachrichten, sodass Administratoren sofort verstehen, was schief gelaufen ist (Rate Limit, ungültiger Schlüssel, Modell nicht verfügbar usw.).', version: 'v2.1.0', domains: ['ai', 'productivity'] },
  { title: 'Anklickbare Dashboard-Produktstatistiken', desc: 'Produktstatistik-Karten auf dem Dashboard (Active, Inactive, Enriched, With Variants, …) fungieren nun als Filter-Chips — ein Klick verlinkt direkt in das Produktraster, vorgefiltert nach dieser Gruppe.', version: 'v2.1.0', domains: ['productivity', 'reporting'] },
  { title: 'Asynchrones Produkt-Webhook-Dispatch', desc: 'Webhook-Lieferungen für Produkterstellung/-aktualisierung laufen nun als in die Warteschlange eingereihter SendProductWebhook-Job, sodass Admin-Aktionen sofort zurückkehren und die Latenz externer Endpunkte die Admin-Benutzeroberfläche nicht mehr blockiert.', version: 'v2.1.0', domains: ['connectivity', 'automation', 'scalability'] },
  { title: 'Rate-Limiting für Admin-Login', desc: 'Benannte Rate-Limiter mit Segmentierung pro E-Mail + pro IP (5 Versuche/Minute) schützen die Endpunkte für Admin-Login und Passwort-Wiederherstellung vor Brute-Force-Angriffen.', version: 'v2.1.0', domains: ['governance', 'scalability'] },
  { title: 'Serverseitige Passwortvalidierung', desc: 'Eine Mindestlänge von 6 Zeichen für Passwörter wird in UserForm serverseitig erzwungen und schließt eine Lücke, in der Clients Passwortregeln umgehen konnten.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Benutzerenumeration-Härtung', desc: 'Der Endpunkt für die Passwort-Wiederherstellung gibt nun unabhängig davon, ob die E-Mail existiert, eine generische Nachricht zurück, was Account-Enumeration über Antwortunterschiede verhindert.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Open-Redirect-Schutz', desc: 'Referer-basierte Weiterleitungen bei Login und Passwort-Wiederherstellung validieren nun den Host über parse_url(), sodass gefälschte Referer-Header Benutzer nicht mehr auf externe Phishing-Seiten umleiten können.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Fix für Berechtigungsausweitung beim Benutzer-Edit', desc: 'Fehlende ACL-Einträge und Controller-Level-Schutzmaßnahmen wurden zu den User-Update- und Destroy-Endpunkten hinzugefügt; Nicht-Superadmins können keine permission_type: all-Rollen mehr zuweisen. Behebt den High-Severity-Audit-Befund.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'No-Cache-Middleware für Admin-Seiten', desc: 'Admin-Antworten enthalten Cache-Control: no-store- und Pragma: no-cache-Header, die verhindern, dass Browser und Proxys sensible Seiten nach der Abmeldung zwischenspeichern.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Erweiterte Secure Headers', desc: 'Permissions-Policy- und X-Permitted-Cross-Domain-Policies-Header werden nun bei allen Admin-Antworten gesendet, für stärkere Schutzmaßnahmen auf Browserebene.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'XSS-Sanitization-Helper', desc: 'clean_content()-Helper, unterstützt von HTMLPurifier, entfernt Blade-Direktiven, PHP-Tags und gefährliches HTML aus benutzergenerierten Inhalten vor der Speicherung.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'IP-basierte Debug-Filterung', desc: 'Die Umgebungsvariable APP_DEBUG_ALLOWED_IPS beschränkt den Debugbar-Zugriff auf bestimmte IPs, sodass das Produktions-Debugging sicherer ist.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Verbesserte niederländische (nl_NL) Übersetzungen', desc: 'Qualitätsdurchgang über neun Pakete (Admin, AiAgent, Completeness, Core, DataTransfer, Installer, Product, Webhook) — informeller Ton, Entfernung verirrter Präfixe, Bereinigung von Zero-Width Spaces. Community-Beitrag.', version: 'v2.1.0', domains: ['productivity'] },
  { title: 'Datenbank-Index-Performance-Durchgang', desc: 'Neue Indizes auf channels.code, locales.status, currencies.status und ein zusammengesetzter Index auf core_config(code, channel_code, locale_code) für schnellere Konfigurationsabfragen und Admin-Seitenladezeiten.', version: 'v2.1.0', domains: ['scalability'] },
  { title: 'PostgreSQL-Kompatibilitäts-Durchgang', desc: 'JSON-Suchunterstützung, jsonContains()-Grammatik, Treiber-getrennte MySQL-Bulk-Modus-Sitzungsvariablen und DataGrid-Filter-Fixes über AiAgent-Tools, Channel- und AttributeOption-Grids.', version: 'v2.1.0', domains: ['connectivity', 'scalability'] },
  { title: 'Dark-Mode-Politur im Job-Tracker', desc: 'Fortschrittsbalken und Konfigurationsschaltflächen werden nun im Dark-Mode innerhalb des Import-/Export-Job-Trackers korrekt gerendert.', version: 'v2.1.0', domains: ['productivity'] },
  { title: 'PostgreSQL-CI-Workflow', desc: 'Ein dedizierter Pest-Testlauf gegen PostgreSQL 16 (mit und ohne Elasticsearch) bei jeder Änderung hält die datenbankübergreifende Kompatibilität stabil.', version: 'v2.1.0', domains: ['scalability', 'governance'] },
