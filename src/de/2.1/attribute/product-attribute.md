...
<ImagePopup src="/assets/2.1/images/attributes/createAttribute.png" alt="Attribut erstellen" />

**Schritt 2** — Geben Sie den **Code** und den **Data Type** im allgemeinen Abschnitt ein.

<ImagePopup src="/assets/2.1/images/attributes/general.png" alt="Allgemeiner Abschnitt" />
...
<ImagePopup src="/assets/2.1/images/attributes/label.png" alt="Label-Abschnitt" />

**Schritt 4** — Wählen Sie **Validation** aus, wenn das Attribut erforderlich oder eindeutig sein soll.

**Hinweis** — Die **Is Unique**-Validierung ist nur für die Typen **Text, Datetime & Date** verfügbar.

<ImagePopup src="/assets/2.1/images/attributes/validation.png" alt="Validierungsabschnitt" />
...
<ImagePopup src="/assets/2.1/images/attributes/configuration.png" alt="Konfigurationsabschnitt" />
...
<ImagePopup src="/assets/2.1/images/attributes/output.png" alt="Attribut-Datagrid" />
...
<ImagePopup src="/assets/2.1/images/attributes/family.png" alt="Attributfamilien-Zuweisung" />
...
<ImagePopup src="/assets/2.1/images/attributes/product.png" alt="Attribut auf der Produktbearbeitungsseite angezeigt" />
...
<ImagePopup src="/assets/2.1/images/attributes/text.png" alt="Text-Attribut" />
...
<ImagePopup src="/assets/2.1/images/attributes/textarea.png" alt="Textarea-Attribut" />

**3) Boolean** — Wahr/Falsch-Schalter. Wird für Ja/Nein- oder Ein/Aus-Auswahlen verwendet.

<ImagePopup src="/assets/2.1/images/attributes/boolean.png" alt="Boolean-Attribut" />

**4) Select** — Ein Dropdown, das eine Auswahl aus einer vordefinierten Liste ermöglicht.

<ImagePopup src="/assets/2.1/images/attributes/select.png" alt="Select-Attribut" />

**5) Multiselect** — Wie Select, erlaubt aber mehrere Auswahlen aus der Liste.

<ImagePopup src="/assets/2.1/images/attributes/multiselect.png" alt="Multiselect-Attribut" />

**6) Datetime** — Wählen Sie ein bestimmtes Datum und eine bestimmte Uhrzeit. Wird für Zeitplanung und Zeitstempel verwendet.

<ImagePopup src="/assets/2.1/images/attributes/datetime.png" alt="Datetime-Attribut" />

**7) Date** — Wählen Sie nur ein Datum (keine Uhrzeit).

<ImagePopup src="/assets/2.1/images/attributes/date.png" alt="Date-Attribut" />
...
<ImagePopup src="/assets/2.1/images/attributes/gallery.png" alt="Gallery-Attribut mit Video" />
...
<ImagePopup src="/assets/2.1/images/attributes/image.png" alt="Image-Attribut" />

**10) File** — Hochladen beliebiger Dateien (Dokumente, Bilder usw.).

<ImagePopup src="/assets/2.1/images/attributes/file.png" alt="File-Attribut" />

**11) Checkbox** — Eine umschaltbare Checkbox für binäre Auswahlen (Zustimmungen, Präferenzen).

<ImagePopup src="/assets/2.1/images/attributes/checkbox.png" alt="Checkbox-Attribut" />

**12) Price** — Ein Preisfeld zusätzlich zum vordefinierten **Prices**-Attribut.

<ImagePopup src="/assets/2.1/images/attributes/price.png" alt="Price-Attribut" />
