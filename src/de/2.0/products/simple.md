...
<ImagePopup src="/assets/2.0/images/simple-product/simple.png" alt="Modal zum Erstellen eines einfachen Produkts" />

UnoPim schließt den Dialog und leitet Sie zur Bearbeitungsseite weiter, wo jedes verbleibende Feld ausgefüllt werden kann.

<ImagePopup src="/assets/2.0/images/simple-product/editProduct.png" alt="Einfaches Produkt bearbeiten" />
...
<ImagePopup src="/assets/2.0/images/simple-product/datagrid.png" alt="Produkte-Datagrid" />
...
<ImagePopup src="/assets/2.0/images/simple-product/product-edit-locale.png" alt="Produktbearbeitung mit Locale-Switcher" />

#### Manuelle Übersetzung

1. Öffnen Sie das Produkt in **Catalog → Products**.
2. Verwenden Sie oben auf der Bearbeitungsseite die beiden Schalter:
   - **Channel Switcher** (z. B. *Default*) — wählt aus, welchen Kanalwerten Sie bearbeiten.
...
<ImagePopup src="/assets/2.0/images/simple-product/columns-selector.png" alt="Spaltenauswahl" />
