...
<ImagePopup src="/assets/2.0/images/dashboard/dashboard-overview.png" alt="Dashboard-Übersicht" />
...
| **Aktiv / Inaktiv** | Wie viele Produkte derzeit aktiviert vs. deaktiviert sind. |
...
<ImagePopup src="/assets/2.0/images/settings/dark-theme.png" alt="Dunkles Theme" />
