...
<ImagePopup src="/assets/2.1/images/configuration/AiConfiguration.png" alt="Visión general de Configuración de Magic AI" />
...
El pipeline es el mismo para cada característica de IA — desde la generación de campos hasta el AI Agent:
...
<ImagePopup src="/assets/2.1/images/magic-ai/magic-ai-config-flow.png" alt="Jerarquía de Configuración de Magic AI" />
...
<ImagePopup src="/assets/2.1/images/magic-ai/add-platform.png" alt="Añadir AI Platform — Paso 1" />
...
<ImagePopup src="/assets/2.1/images/magic-ai/magic-ai-settings.png" alt="Ajustes de Magic AI" />
