...
El panel de analytics es la capa de observabilidad que se sitúa sobre los controles que configuró bajo **Magic AI → Ajustes → Agentic PIM**. Juntos forman un bucle de retroalimentación continua:

<ImagePopup src="/assets/2.1/images/ai-agent/analytics-feedback-loop.png" alt="Bucle de Retroalimentación de Gestión del AI Agent" />
