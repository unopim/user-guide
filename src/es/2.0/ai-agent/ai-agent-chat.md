...
- **Sessions** — Sus conversaciones pasadas. Una insignia numérica en la pestaña muestra cuántas sesiones no han sido leídas.
 ...
 <ImagePopup src="/assets/2.0/images/ai-agent/ai-agent-chat-tab.png" alt="Pestaña de AI Agent Chat" />
...
| 11 | **Bulk Import CSV** | Suba CSV/XLSX para actualización por lotes |
...
| 24 | **Manage Associations** | Añada, elimine o liste productos relacionados/up-sell/cross-sell mediante lenguaje natural *(v2.0.x)* |
...
La pestaña Sessions lista cada chat pasado. Cada entrada muestra el título de la sesión, número de mensajes y fecha de última actividad.
 ...
 <ImagePopup src="/assets/2.0/images/ai-agent/ai-agent-sessions.png" alt="Sesiones de AI Agent" />
