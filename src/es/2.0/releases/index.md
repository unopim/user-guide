...
const features = [
  // v2.0.x
  { title: 'Herramienta Manage Associations', desc: 'Nueva herramienta del AI Agent que añade, elimina o lista productos related/up-sell/cross-sell vía lenguaje natural — no es necesario abrir cada producto manualmente.', version: 'v2.0.x', domains: ['ai', 'productivity'] },
  { title: 'Opción de Instalador --with-demo-data', desc: 'Nueva bandera del instalador que siembra productos, categorías y atributos de muestra en el momento de la instalación para que pueda evaluar UnoPim con datos realistas inmediatamente.', version: 'v2.0.x', domains: ['productivity', 'governance'] },
  { title: 'Limitación de Tasa de Inicio de Sesión del Administrador', desc: 'Limitadores de tasa con nombre con segmentación por email + por IP protegen el inicio de sesión del administrador de ataques de fuerza bruta.', version: 'v2.0.x', domains: ['governance', 'scalability'] },
  { title: 'Validación de Contraseña del Lado del Servidor', desc: 'Longitud mínima de contraseña aplicada en el lado del servidor, cerrando una laguna donde los clientes podían saltarse las reglas de contraseña.', version: 'v2.0.x', domains: ['governance'] },
  { title: 'Refuerzo de Enumeración de Usuarios', desc: 'El endpoint de olvido de contraseña ahora devuelve un mensaje genérico independientemente de si el email existe, previniendo la enumeración de cuentas.', version: 'v2.0.x', domains: ['governance'] },
  { title: 'Protección contra Open-Redirect', desc: 'Las redirecciones basadas en Referer ahora validan el host vía parse_url() para bloquear el abuso de open-redirect.', version: 'v2.0.x', domains: ['governance'] },
  { title: 'Corrección de Escalada de Privilegios en Edición de Usuario', desc: 'Añadidas las entradas ACL faltantes y salvaguardas a nivel de controlador en el endpoint de edición de usuario para prevenir la escalada de privilegios.', version: 'v2.0.x', domains: ['governance'] },
  { title: 'Middleware No-Cache para Páginas de Administración', desc: 'Las respuestas del administrador incluyen encabezados cache-control que evitan que los navegadores cacheen páginas sensibles después de cerrar sesión.', version: 'v2.0.x', domains: ['governance'] },
  { title: 'Encabezados Seguros Mejorados', desc: 'Los encabezados Permissions-Policy y X-Permitted-Cross-Domain-Policies ahora se envían en todas las respuestas del administrador para protecciones más fuertes a nivel de navegador.', version: 'v2.0.x', domains: ['governance'] },
  { title: 'Helper de Saneamiento XSS', desc: 'El helper clean_content() respaldado por HTMLPurifier estandariza el renderizado seguro de HTML a través de la UI de administración.', version: 'v2.0.x', domains: ['governance'] },
  { title: 'Filtrado de Debug Basado en IP', desc: 'La variable de entorno APP_DEBUG_ALLOWED_IPS restringe la salida de debug a IPs específicas para que la depuración en producción sea más segura.', version: 'v2.0.x', domains: ['governance'] },
  { title: 'Actualización a Vite 6.3', desc: 'Construcción frontend actualizada de Vite 4.0 a 6.3 con división manual de chunks y división de código CSS para cargas de administración más rápidas.', version: 'v2.0.x', domains: ['productivity', 'scalability'] },
  { title: 'Pulido del Modo Oscuro en el Seguimiento de trabajos', desc: 'Las barras de progreso y los botones de configuración ahora se renderizan correctamente en modo oscuro dentro del seguimiento de trabajos de importación/exportación.', version: 'v2.0.x', domains: ['productivity'] },
  { title: 'Flujo de Trabajo CI de PostgreSQL', desc: 'Ejecución dedicada de tests Pest contra PostgreSQL en cada cambio mantiene estable la compatibilidad entre bases de datos.', version: 'v2.0.x', domains: ['scalability', 'governance'] },
