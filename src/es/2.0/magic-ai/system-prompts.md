...
```
Cualquier solicitud de Magic AI (icono de varita, auto-traducción, chat del agente, auto-enriquecimiento)
           │
           ▼
Magic AI elige el Prompt que coincide       ← desde Magic AI → Prompts
           │
           ▼
Se antepone el System Prompt activo         ← desde Magic AI → System Prompts
   (tono + temperatura + tokens máximos)
           │
           ▼
Solicitud combinada enviada a Plataforma + Modelo  ← desde Magic AI → Ajustes
```
