...
1. **Crear** — establece el tipo de producto en `Simple`, elige una familia de atributos y le da un SKU. Eso crea un registro mínimo.
...
<ImagePopup src="/assets/2.0/images/simple-product/simple.png" alt="Modal Crear Producto Simple" />

UnoPim cierra el diálogo y le redirige a la página de edición, donde puede rellenarse cada campo restante.

<ImagePopup src="/assets/2.0/images/simple-product/editProduct.png" alt="Editar Producto Simple" />
...
<ImagePopup src="/assets/2.0/images/simple-product/datagrid.png" alt="Datagrid de Productos" />
...
<ImagePopup src="/assets/2.0/images/simple-product/product-edit-locale.png" alt="Edición de Producto con Conmutador de Locale" />
...
<ImagePopup src="/assets/2.0/images/simple-product/columns-selector.png" alt="Selector de Columnas" />
