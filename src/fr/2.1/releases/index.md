...
const features = [
  // v2.1.0
  { title: 'Outil Manage Associations', desc: 'Nouvel outil AI Agent qui ajoute, supprime ou liste les produits related/up-sell/cross-sell via le langage naturel — pas besoin d\'ouvrir chaque produit manuellement. Les résultats de recherche de produit affichent désormais des liens cliquables pour une navigation simplifiée.', version: 'v2.1.0', domains: ['ai', 'productivity'] },
  { title: 'Demo Data Seeding', desc: 'Onboarding rapide avec des produits, catégories et attributs d\'exemple — disponible via le bascule de l\'assistant d\'installation, le flag CLI `php artisan unopim:install --with-demo-data`, l\'option de configuration Docker, ou la commande autonome `php artisan unopim:install:demo-data`.', version: 'v2.1.0', domains: ['productivity', 'governance'] },
  { title: 'Configuration Docker prête pour la production', desc: 'Stack multi-conteneurs (Nginx + PHP-FPM par défaut, Apache en repli) livré via les images Docker Hub, avec healthchecks, services Redis, Elasticsearch, Mailpit, php.ini optimisé OPcache et workflow de publication automatique.', version: 'v2.1.0', domains: ['connectivity', 'scalability'] },
  { title: 'MagicAI Custom Provider', desc: 'Connectez n\'importe quel service compatible OpenAI (passerelles auto-hébergées, proxies, endpoints personnalisés) en configurant une base URL personnalisée sur la page Magic AI Platforms — au-delà des préréglages officiels OpenAI/Anthropic/Gemini/Ollama/Groq.', version: 'v2.1.0', domains: ['ai', 'connectivity'] },
  { title: 'MagicAI Test Connection (ModelRecommender)', desc: 'Le Test Connection sur une Platform utilise désormais un recommender dédié qui ignore les modèles image uniquement, empêchant les faux négatifs lors de la validation des identifiants.', version: 'v2.1.0', domains: ['ai', 'governance'] },
  { title: 'PrismErrorResolver', desc: 'L\'AI Agent Chat traduit les erreurs du fournisseur et de Prism en messages conviviaux, afin que les administrateurs comprennent immédiatement ce qui s\'est mal passé (limite de débit, clé invalide, modèle indisponible, etc.).', version: 'v2.1.0', domains: ['ai', 'productivity'] },
  { title: 'Statistiques produit cliquables sur le tableau de bord', desc: 'Les cartes de statistiques produit sur le tableau de bord (Active, Inactive, Enriched, With Variants, …) agissent désormais comme des puces de filtre — cliquer sur l\'une renvoie directement à la grille de produits préfiltrée à cet ensemble.', version: 'v2.1.0', domains: ['productivity', 'reporting'] },
  { title: 'Distribution asynchrone des webhooks produit', desc: 'Les livraisons de webhooks de création/mise à jour de produit s\'exécutent désormais comme un job SendProductWebhook en file d\'attente, afin que les actions d\'administration reviennent immédiatement et que la latence des endpoints externes ne bloque plus l\'UI d\'administration.', version: 'v2.1.0', domains: ['connectivity', 'automation', 'scalability'] },
  { title: 'Limitation de débit pour la connexion admin', desc: 'Des limiteurs de débit nommés avec segmentation par email + par IP (5 tentatives/minute) protègent les endpoints de connexion admin et de mot de passe oublié contre les attaques par force brute.', version: 'v2.1.0', domains: ['governance', 'scalability'] },
  { title: 'Validation de mot de passe côté serveur', desc: 'Longueur minimale de mot de passe de 6 caractères imposée côté serveur dans UserForm, comblant une lacune où les clients pouvaient contourner les règles de mot de passe.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Durcissement contre l\'énumération d\'utilisateurs', desc: 'L\'endpoint de mot de passe oublié renvoie désormais un message générique, que l\'email existe ou non, empêchant l\'énumération de comptes via les différences de réponse.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Protection contre l\'open-redirect', desc: 'Les redirections basées sur le Referer lors de la connexion et du mot de passe oublié valident désormais l\'hôte via parse_url() afin que les en-têtes Referer falsifiés ne puissent plus pousser les utilisateurs vers des sites de phishing externes.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Correctif d\'élévation de privilèges sur l\'édition d\'utilisateur', desc: 'Ajout d\'entrées ACL manquantes et de gardes au niveau du contrôleur sur les endpoints de mise à jour et de suppression d\'utilisateur ; les non-superadmins ne peuvent plus attribuer de rôles permission_type: all. Corrige la découverte d\'audit de gravité High.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Middleware No-Cache pour les pages d\'administration', desc: 'Les réponses d\'administration incluent les en-têtes Cache-Control: no-store et Pragma: no-cache qui empêchent les navigateurs et les proxies de mettre en cache les pages sensibles après la déconnexion.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'En-têtes sécurisés améliorés', desc: 'Les en-têtes Permissions-Policy et X-Permitted-Cross-Domain-Policies sont désormais envoyés sur toutes les réponses d\'administration pour des protections plus fortes au niveau du navigateur.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Helper de nettoyage XSS', desc: 'Helper clean_content() supporté par HTMLPurifier qui supprime les directives Blade, les tags PHP et le HTML dangereux du contenu généré par l\'utilisateur avant le stockage.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Filtrage de debug basé sur l\'IP', desc: 'La variable d\'environnement APP_DEBUG_ALLOWED_IPS restreint l\'accès au debugbar à des IPs spécifiques afin que le debug en production soit plus sûr.', version: 'v2.1.0', domains: ['governance'] },
  { title: 'Améliorations des traductions néerlandaises (nl_NL)', desc: 'Passe de qualité sur neuf packages (Admin, AiAgent, Completeness, Core, DataTransfer, Installer, Product, Webhook) — ton informel, suppression de préfixes parasites, nettoyage des espaces de largeur nulle. Contribution communautaire.', version: 'v2.1.0', domains: ['productivity'] },
  { title: 'Passe de performance d\'index de base de données', desc: 'Nouveaux index sur channels.code, locales.status, currencies.status, et un index composite sur core_config(code, channel_code, locale_code) pour des recherches de config et des chargements de pages admin plus rapides.', version: 'v2.1.0', domains: ['scalability'] },
  { title: 'Passe de compatibilité PostgreSQL', desc: 'Support de recherche JSON, grammaire jsonContains(), variables de session du mode bulk MySQL gated par driver, et corrections de filtres DataGrid sur les grilles AiAgent tools, Channel et AttributeOption.', version: 'v2.1.0', domains: ['connectivity', 'scalability'] },
  { title: 'Finitions du mode sombre dans Suivi de tâches', desc: 'Les barres de progression et les boutons de configuration s\'affichent désormais correctement en mode sombre à l\'intérieur du Suivi de tâches d\'import/export.', version: 'v2.1.0', domains: ['productivity'] },
  { title: 'Workflow CI PostgreSQL', desc: 'Exécution de tests Pest dédiée sur PostgreSQL 16 (avec et sans Elasticsearch) à chaque changement maintient la compatibilité multi-bases stable.', version: 'v2.1.0', domains: ['scalability', 'governance'] },
