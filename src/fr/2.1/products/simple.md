...
<ImagePopup src="/assets/2.1/images/simple-product/simple.png" alt="Modale Créer un produit simple" />

UnoPim ferme la boîte de dialogue et vous redirige vers la page d'édition, où chaque champ restant peut être rempli.

<ImagePopup src="/assets/2.1/images/simple-product/editProduct.png" alt="Éditer un produit simple" />
...
<ImagePopup src="/assets/2.1/images/simple-product/datagrid.png" alt="Datagrid des produits" />
...
<ImagePopup src="/assets/2.1/images/simple-product/product-edit-locale.png" alt="Édition de produit avec sélecteur de locale" />
...
<ImagePopup src="/assets/2.1/images/simple-product/columns-selector.png" alt="Sélecteur de colonnes" />
