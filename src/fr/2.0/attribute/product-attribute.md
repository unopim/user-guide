...
<ImagePopup src="/assets/2.0/images/attributes/createAttribute.png" alt="Créer un attribut" />

**Étape 2** — Saisissez le **Code** et le **Data Type** dans la section générale.

<ImagePopup src="/assets/2.0/images/attributes/general.png" alt="Section générale" />
...
<ImagePopup src="/assets/2.0/images/attributes/label.png" alt="Section Label" />

**Étape 4** — Sélectionnez **Validation** si vous voulez que l'attribut soit requis ou unique.

**Note** — La validation **Is Unique** n'est disponible que pour les types **Text, Datetime et Date**.

<ImagePopup src="/assets/2.0/images/attributes/validation.png" alt="Section Validation" />
...
<ImagePopup src="/assets/2.0/images/attributes/configuration.png" alt="Section Configuration" />
...
<ImagePopup src="/assets/2.0/images/attributes/output.png" alt="Datagrid des attributs" />
...
<ImagePopup src="/assets/2.0/images/attributes/family.png" alt="Affectation à une famille d'attributs" />
...
<ImagePopup src="/assets/2.0/images/attributes/product.png" alt="Attribut affiché sur la page d'édition du produit" />
...
<ImagePopup src="/assets/2.0/images/attributes/text.png" alt="Attribut Text" />
...
<ImagePopup src="/assets/2.0/images/attributes/textarea.png" alt="Attribut Textarea" />

**3) Boolean** — Bascule vrai / faux. Utilisé pour les sélections oui/non ou marche/arrêt.

<ImagePopup src="/assets/2.0/images/attributes/boolean.png" alt="Attribut Boolean" />

**4) Select** — Une liste déroulante permettant un choix parmi une liste prédéfinie.

<ImagePopup src="/assets/2.0/images/attributes/select.png" alt="Attribut Select" />

**5) Multiselect** — Comme Select mais permet plusieurs choix parmi la liste.

<ImagePopup src="/assets/2.0/images/attributes/multiselect.png" alt="Attribut Multiselect" />

**6) Datetime** — Choisissez une date et une heure spécifiques. Utilisé pour la planification et les horodatages.

<ImagePopup src="/assets/2.0/images/attributes/datetime.png" alt="Attribut Datetime" />

**7) Date** — Choisissez uniquement une date (sans composant horaire).

<ImagePopup src="/assets/2.0/images/attributes/date.png" alt="Attribut Date" />
...
<ImagePopup src="/assets/2.0/images/attributes/gallery.png" alt="Attribut Gallery avec vidéo" />
...
<ImagePopup src="/assets/2.0/images/attributes/image.png" alt="Attribut Image" />

**10) File** — Téléverser des fichiers arbitraires (documents, images, etc.).

<ImagePopup src="/assets/2.0/images/attributes/file.png" alt="Attribut File" />

**11) Checkbox** — Une case à cocher basculable pour les sélections binaires (accords, préférences).

<ImagePopup src="/assets/2.0/images/attributes/checkbox.png" alt="Attribut Checkbox" />

**12) Price** — Un champ de prix en plus de l'attribut prédéfini **Prices**.

<ImagePopup src="/assets/2.0/images/attributes/price.png" alt="Attribut Price" />
