...
Turn the feature on: **Configuration → Digital Product Passport → Product Passport → Enabled**. To serve the public pages, also enable **Configuration → Digital Product Passport → Publication**.
