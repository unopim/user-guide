...
**Step 1:** On the Admin panel of UnoPim go to **Settings → Locales → Create Locale** as shown below.
 ...
 <ImagePopup src="/assets/3.0/images/settings/createLocale.png" alt="Locales" />
...
<ImagePopup src="/assets/3.0/images/settings/newLocale.png" alt="New Locale" />

**Step 3** Now a new locale is created successfully as shown in the below image.

<ImagePopup src="/assets/3.0/images/settings/grid.png" alt="Grid" />
...
<ImagePopup src="/assets/3.0/images/settings/channel.png" alt="Channel" />
...
<ImagePopup src="/assets/3.0/images/settings/switcher.png" alt="Channel" />
