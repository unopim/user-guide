...
3. **Dispatch** — the assembled request goes to the Platform and Model you selected for that capability under **Magic AI → Settings**.
...
<ImagePopup src="/assets/3.0/images/magic-ai/content.png" alt="Magic AI content generation" />
...
**UnoPim 3.0 supports ten providers:**

* **OpenAI** — GPT models for text, DALL-E for images
* **Anthropic** — the Claude model family for text generation and reasoning
* **Gemini** — Google's Gemini models for text and images
* **Groq** — fast, low-cost hosted open models
* **Ollama** — self-hosted local models
* **xAI** — Grok models for text and images
* **Mistral** — Mistral's model family
* **DeepSeek** — DeepSeek's model family
* **Azure** — OpenAI models hosted on Microsoft Azure
* **Custom** — any OpenAI-compatible service, using your own API URL

You don't maintain model lists by hand: when you add a platform and enter its API key, UnoPim **fetches the provider's current models for you** and pre-selects recommended ones (see [Platforms](../magic-ai/platforms.md)).

::: tip
All providers are managed through one shared connection layer, so you can switch providers without changing your workflow.
:::
...
7. Click **Save** on the Save / Discard bar to keep the changes.
...
8. Click **Save** on the Save / Discard bar.
