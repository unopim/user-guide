...
## What you can import in 3.0

Imports used to cover products and categories. UnoPim 3.0 lets you import your whole catalog structure and even your team setup:
...
Every type comes with a downloadable sample file showing the expected columns, and every type supports localized values — a label column per language, so you can load names in all your languages in one file.

<ImagePopup src="/assets/3.0/images/data-transfer/import-types.png" alt="Import type selection" />
...
**Step 1:** Go to the Admin panel of UnoPim and click on **Data Transfer → Imports** in the sidebar then click the **Create Import** button.
 ...
 <ImagePopup src="/assets/3.0/images/data-transfer/import-listing.png" alt="Import Listing" />

**Step 2:** Under general configurations add the below fields:

1) **Code -** Enter the code of your Import process.

2) **Type -** Select what you want to import — any of the types listed above, from Products to Users.
...
Now, click on **Save Import** button.  
 ...
 <ImagePopup src="/assets/3.0/images/data-transfer/create-import-form.png" alt="Create Import Form" />

The create import form has a two-panel layout:
- **General panel (left)** — Code, Type, plus a combined **File / Images** block with the file upload area, the *Download {Type} Sample CSV* link, and the **Images → Path** field with its *Upload Images to set Path* button.
...
**Step 4:** The Job Tracker detail page shows the step pipeline in real time. If validation catches errors, the page surfaces them with row numbers and the exact field that failed, plus a **Download Full Report** button:
 ...
 <ImagePopup src="/assets/3.0/images/data-transfer/import-progress.png" alt="Import detail page — validation errors" />
