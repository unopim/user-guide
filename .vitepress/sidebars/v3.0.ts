// .vitepress/sidebars/v3.0.ts
const version = '3.0'

export default [
  { text: 'Introduction', link: `/${version}/introduction/` },
  { text: "What's New", link: `/${version}/releases/` },
  { text: 'First Steps', link: `/${version}/introduction/first-steps` },
  { text: 'Admin Essentials', link: `/${version}/introduction/admin-essentials` },
  { text: 'PIM Concepts & Glossary', link: `/${version}/introduction/glossary` },
...

  {
    ...
    items: [
      ...
      { text: 'Product Variants', link: `/${version}/products/variants` },
      { text: 'Filters & Saved Views', link: `/${version}/products/filters-and-views` }
    ]
  },

  {
    text: 'Product Associations',
    link: `/${version}/associations/`,
    collapsed: false,
    items: [
      { text: 'Association Types', link: `/${version}/associations/association-types` },
      { text: 'Linking Products', link: `/${version}/associations/linking-products` }
    ]
  },
  ...
  { text: 'Measurements', link: `/${version}/measurements/` },
...

  {
    ...
    items: [
      ...
      { text: 'System Settings', link: `/${version}/configuration/system-settings` }
    ]
  },
